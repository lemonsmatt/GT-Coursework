...
csvfile_rhc = open("out/countones_RHC.csv", "w+", 0)
writer_rhc = csv.writer(csvfile_rhc, delimiter=",")

csvfile_sa = open("out/countones_SA.csv", "w+", 0)
writer_sa = csv.writer(csvfile_sa, delimiter=",")

csvfile_ga = open("out/countones_GA.csv", "w+", 0)
writer_ga = csv.writer(csvfile_ga, delimiter=",")

csvfile_mimic = open("out/countones_MIMIC.csv", "w+", 0)
